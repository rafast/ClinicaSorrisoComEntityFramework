using ClinicaSorriso.ConsoleApp.Helpers;
    ...
    public static class PacienteView
    {
        ...
        public static void ListarPacientes(List<Paciente> pacientes)
        {
            ...
            foreach (var paciente in pacientes)
            {
                ...
                {
                    Console.WriteLine(String.Format("{0,-11} {1,-12} ", " ", $"Agendado para: {paciente.ConsultaMarcada[0].Data.ToString("dd/MM/yyyy")}"));
                    Console.WriteLine(String.Format("{0,-11} {1,-12} ", " ", $"{paciente.ConsultaMarcada[0].GetHorario(paciente.ConsultaMarcada[0].HoraInicio)} às {paciente.ConsultaMarcada[0].GetHorario(paciente.ConsultaMarcada[0].HoraFim)}"));
                }
            }
        }
